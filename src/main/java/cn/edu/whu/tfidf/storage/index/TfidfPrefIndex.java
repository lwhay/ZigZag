...
import cn.edu.whu.idf.storage.index.LinkList;
import cn.edu.whu.idf.storage.index.ListNode;
...
public class TfidfPrefIndex implements iIndex {
    ...
    public TfidfPrefIndex(TfIdfDataReader dataReader,
            TfidfConfig conf,
        ...
        String lengthPath = conf.getIndexPath().substring(0, conf.getIndexPath().lastIndexOf(File.separator) + 1)
                + "lengthBtree";
        ...
        String tfmaxPath = conf.getIndexPath().substring(0, conf.getIndexPath().lastIndexOf(File.separator) + 1)
                + "tfmaxBtree";
