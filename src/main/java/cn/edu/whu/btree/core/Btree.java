...
public class Btree<T extends Comparable<T>, V> {
    ...
    private int keyNum, keylen, rootaddr, headaddr, nodecachesize, tailaddr, blockSize, interInitial = -1,
            leafInitial = -2,
            inodensize = 12, internsize, InterNum, LeafNum, dataBlockNum,
            leafnsize, nodeNumOfBlock, datacachesize, treecachesize, size;
    ...
    public void insert(T key, V value) {
        ...
        if (valuetype == Integer.class) {//Integer and long only for test, no use
            data = new byte[4];
            Utils.getBytes4((int) value, data, 0);
    ...
    private class TreeCache {
        ...
        private int leafMax, interMax, nBlockBase, discard, leafno, leafoff, interno, interoff, datano,
                dataoff;
